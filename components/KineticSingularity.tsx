  ...
  return (
    <div className="min-h-[80vh] bg-gray-950 rounded-[4rem] border border-white/5 shadow-2xl relative overflow-hidden p-10 md:p-20 text-white">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-12">
        ...
        {/* The Action Barrier */}
        <div className="pt-20">
           <p className="text-gray-600 text-[9px] font-black uppercase tracking-[0.5em] mb-4">Do not manage. Do not control.</p>
           <div className="flex gap-4">
              <button className="bg-indigo-600 text-white px-12 py-5 rounded-[2rem] font-black uppercase text-[11px] tracking-widest shadow-[0_0_40px_rgba(79,70,229,0.4)] hover:scale-105 transition-all">
                Enter Flow State
              </button>
           </div>
        </div>
